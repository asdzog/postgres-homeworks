...
SELECT AVG(shipped_date - order_date) avg_shipping_days FROM orders WHERE ship_country = 'Germany';
...
SELECT MIN(unit_price) min_price, MAX(unit_price) max_price
FROM products
...
SELECT MIN(unit_price) min_price, MAX(unit_price) max_price FROM products
